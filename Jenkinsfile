  ...
  try {
   stage('Integration Tests') {
	...
	bat """
		...
		cucumber-js --format json:${env.WORKSPACE}/apigee-cicd/cicd-api/test/features/reports.json  ${env.WORKSPACE}apigee-cicd/cicd-api/test/features/prod_tests.feature
		"""	 
